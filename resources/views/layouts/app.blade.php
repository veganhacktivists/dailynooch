        ...
        <div class="card mb-4 border-0">
          <div class="card-body">
            <blockquote class="blockquote">
              <span>
              😍 Find the latest vegan news, recipes and more! Explore new vegan content every day by
              <a id="bookmark-this" class="btn btn-bookmark" href="#">bookmarking this page!</a>
              </span>
            </blockquote>
          </div>
        </div>
