...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <body>
    <div id="app" class="d-flex flex-column min-vh-100">
        ...
        <div class="card mb-4 border-0">
          <div class="card-body">
            <blockquote class="blockquote">
              <span>
                😍&nbsp;Find the latest vegan news, recipes and more! Explore new vegan content every day by <a id="bookmark-this" style="margin-left: 5px;background-color: #f0ad4e;box-shadow: 0 0.3em #c78527;" class="btn btn-secondary mt-n1 px-2 py-1" href="#">bookmarking this page!</a>
              </span>
            </blockquote>
          </div>
        </div>
      ...
      <footer>
        <center><br><img src="https://dailynooch.org/favicon.png" alt="" style="width:20px;margin-top: -4px;">&nbsp;&nbsp;Daily Nooch was created with love by <a href="https://veganhacktivists.org" target="_blank" rel="noopener">Vegan Hacktivists!</a><br><br><a href="https://veganhacktivists.org/contact" target="_blank" rel="noopener">Contact us,</a> or support us <a href="https://www.patreon.com/veganhacktivists" target="_blank" rel="noopener">on Patreon!</a>&nbsp;&nbsp;🐮&nbsp;💕</center>      </main>
        <img src="https://i.imgur.com/LRAAzvY.png" alt="" style="width: 100%;">
      </footer>
    </div>
  </body>
</html>
